...
class Document
{
    ...
    /** @var int The number of IDs generated by this document */
    protected $id = 0;
    ...
    /**
     * Generates an ID. If you pass an element as parameter, it will set the id attribute.
     * @param DOMElement $element The optional element
     * @return string The ID generated
     */
    public function generateID($element = null)
    {
        $id = 'id'.($this->id++);
        if ($element !== null) {
            $id.= base64_encode(sha1($element->getNodePath(), true));
